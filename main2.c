...
// das estruturas de dados dos protocolos.
  ...
  int totalPackets = 0;
  float arpPackets = 0, ipv4Packets = 0, ipv6Packets = 0, icmpPackets = 0, icmpv6Packets = 0, tcpV4Packets = 0, udpV4Packets = 0, tcpV6Packets = 0, udpV6Packets = 0;

  int arpPkgT = 0, ipv4PkgT = 0, ipv6PkgT = 0, icmpPkgT = 0, icmpv6PkgT = 0, tcpV4PkgT = 0, udpV4PkgT = 0, tcpV6PkgT = 0, udpV6PkgT = 0;
  int arpPkgR = 0, ipv4PkgR = 0, ipv6PkgR = 0, icmpPkgR = 0, icmpv6PkgR = 0, tcpV4PkgR = 0, udpV4PkgR = 0, tcpV6PkgR = 0, udpV6PkgR = 0;
	...
	while (1) {
		...
		switch(type) {
			case 0x0800:
				...
				vector_append(&ipsVector, buff1[26] + buff1[27] + buff1[28] + buff1[29]);
